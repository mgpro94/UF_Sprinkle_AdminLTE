    ...
    var pluginName = 'ufTable',
        defaults = {
            ...
            tablesorter     : {
                ...
                widgetOptions : {
                    columnSelector_layout : '<div class="form-check"><input id="columnSelector_{name}" type="checkbox" class="form-check-input"><label for="columnSelector_{name}" class="form-check-label">{name}</label></div>',
